  ...
  return (
    <div className="bg-[var(--bg-2)]">
      <div className="flex items-center justify-between flex-wrap px-3 py-5 md:p-[30px] gap-5 lg:p-[60px] bg-[var(--dark)]">
        <h2 className="h2 text-white">Add New Boat</h2>
        <Link href="/boat/all-boat" className="btn-primary">
          <EyeIcon className="w-5 h-5" /> View All Boat
        </Link>
      </div>
      {/* statisticts */}
      <section className="grid z-[1] grid-cols-12 gap-4 mb-6 lg:gap-6 px-3 md:px-6 bg-[var(--bg-2)] relative after:absolute after:bg-[var(--dark)] after:w-full after:h-[60px] after:top-0 after:left-0 after:z-[-1] pb-10 xxl:pb-0">
        <div className="col-span-12 lg:col-span-6">
          <Accordion
            buttonContent={(open) => (
              <div
                ...
                <h3 className="h3">Boat Content </h3>
                <ChevronDownIcon
            ...
            <div className="px-4 md:px-6 lg:px-8 pb-4 md:pb-6 lg:pb-8 bg-white rounded-b-2xl">
              <div className="border-t pt-4">
                ...
                />
                <p className="mt-6 mb-4 text-xl font-medium">Number :</p>
                <input
                  type="text"
                  className="w-full border p-2 focus:outline-none rounded-md  text-base"
                ...
                <input
                  type="text"
                  className="w-full border p-2 focus:outline-none rounded-md  text-base"
                  placeholder="Cab Sale Price"
                />
                <p className="mt-6 mb-4 text-xl font-medium">
                  {" "}
                  Minimun Advance Reservation :{" "}
                </p>
                <SelectUI
          ...
          <Accordion
            ...
            initialOpen={true}>
            <div className="px-4 md:px-6 lg:px-8 pb-4 md:pb-6 lg:pb-8 bg-white rounded-b-2xl">
              <p className="mb-4 text-xl font-medium">Passenger:</p>
              <input
                type="text"
              ...
              <p className="mb-4 mt-6 text-xl font-medium"> Gear Shift : </p>
              <SelectUI
                options={[{ name: "1" }, { name: "2" }, { name: "3" }]}
              />

              <p className="mt-6 mb-4 text-xl font-medium">Baggage :</p>
              <input
                type="text"
                className="w-full border py-2 px-3 lg:px-4 focus:outline-none rounded-md text-base"
                placeholder="3"
            ...
            <Accordion
              buttonContent={(open) => (
                <div className="rounded-2xl flex items-center justify-between">
                  <h3 className="h3">Attribute : Car Type</h3>
                  <ChevronDownIcon
                    className={`w-5 h-5 sm:w-6 sm:h-6 duration-300 ${
                      open ? "rotate-180" : ""
                    }`}
        ...
        <div className="col-span-12 lg:col-span-6">
          ...
          <div className="rounded-2xl bg-white border p-4 md:p-6 lg:p-8 mt-4 lg:mt-6">
            <Accordion
              buttonContent={(open) => (
                <div className="rounded-2xl flex items-center justify-between">
                  <h3 className="h3">Attributes : Car</h3>
                  <ChevronDownIcon
                    className={`w-5 h-5 sm:w-6 sm:h-6 duration-300 ${
                      open ? "rotate-180" : ""
                    }`}
