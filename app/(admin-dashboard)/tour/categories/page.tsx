  ...
  return (
    <div className="bg-[var(--bg-2)]">
      ...
      <section className="grid z-[1] grid-cols-12 gap-4 mb-6 lg:gap-6 px-3 md:px-6 bg-[var(--bg-2)] relative after:absolute after:bg-[var(--dark)] after:w-full after:h-[60px] after:top-0 after:left-0 after:z-[-1] pb-10 xxl:pb-0">
        <div className="col-span-12 lg:col-span-5 p-4 md:p-6 lg:p-10 rounded-2xl bg-white">
        ...
        <div className="col-span-12 lg:col-span-7 p-4 md:p-6 lg:p-10 rounded-2xl bg-white">
            ...
            <table className="w-full whitespace-nowrap">
              <thead>
                <tr className="text-left bg-[var(--bg-1)] border-b border-dashed">
                  <th className="py-3 lg:py-4 px-2">Categories Name</th>
