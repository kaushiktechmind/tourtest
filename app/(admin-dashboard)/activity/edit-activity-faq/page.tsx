...
const EditActivityFAQ = () => {
      ...
      if (faqId) {
        try {
          const response = await fetch(
            `https://yrpitsolutions.com/tourism_api/api/admin/get_faq_activity_by_id/${faqId}`
          );
  ...
  const handleUpdateFaq = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://yrpitsolutions.com/tourism_api/api/admin/update_activity_faq_by_id/${faqId}`,
        {
      ...
      if (response.ok) {
        ...
        router.push("/activity/activity-faq");
      } else {
