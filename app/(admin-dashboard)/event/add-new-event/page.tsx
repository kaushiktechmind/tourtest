  ...
  return (
    <div className="bg-[var(--bg-2)]">
      <div className="flex items-center justify-between flex-wrap px-3 py-5 md:p-[30px] gap-5 lg:p-[60px] bg-[var(--dark)]">
        <h2 className="h2 text-white">Add New Event</h2>
        <Link href="/event/all-event" className="btn-primary">
          <EyeIcon className="w-5 h-5" /> View All Event
        </Link>
      </div>
      {/* statisticts */}
          ...
          <Accordion
            buttonContent={(open) => (
              <div
                ...
                <h3 className="h3">Event Content </h3>
                <ChevronDownIcon
            ...
            <div className="px-4 md:px-6 lg:px-8 pb-4 md:pb-6 lg:pb-8 bg-white rounded-b-2xl">
              <div className="border-t pt-4">
                <p className="mt-6 mb-4 text-xl font-medium">Event Title:</p>
                <input
                  type="text"
                ...
                <input
                  ...
                  placeholder="2000"
                />
              <p className="mt-6 mb-4 text-xl font-medium">Sell Price :</p>
                <input
                  type="number"
                  className="w-full border p-2 focus:outline-none rounded-md  text-base"
                  placeholder="1500"
          ...
          <Accordion
            buttonContent={(open) => (
              <div
                ...
                <h3 className="h3">Ticket Info </h3>
                <ChevronDownIcon
                  className={`w-5 h-5 sm:w-6 sm:h-6 duration-300 ${
                    open ? "rotate-180" : ""
                  }`}
            ...
            initialOpen={true}>
            <div className="px-4 md:px-6 lg:px-8 pb-4 md:pb-6 lg:pb-8 bg-white rounded-b-2xl">
              <p className="mb-4 text-xl font-medium">Available Tickets</p>
              <input
                type="number"
              ...
              <p className="mb-4 mt-6 text-xl font-medium"> Code : </p>
              <input
                type="text"
                className="w-full border py-2 px-3 lg:px-4 focus:outline-none rounded-md text-base"
                placeholder=""
              ...
              <input
                ...
                placeholder=""
              />
              <p className="mt-6 mb-4 text-xl font-medium">Ticket Price :</p>
              <input
                type="number"
                className="w-full border py-2 px-3 lg:px-4 focus:outline-none rounded-md text-base"
                placeholder=""
              />
              <p className="mt-6 mb-4 text-xl font-medium">Door :</p>
              <SelectUI
                options={[
                  { name: "5" },
                  { name: "7" },
            ...
            <Accordion
              buttonContent={(open) => (
                <div className="rounded-2xl flex items-center justify-between">
                  <h3 className="h3">Attribute : Event Type</h3>
                  <ChevronDownIcon
                    className={`w-5 h-5 sm:w-6 sm:h-6 duration-300 ${
                      open ? "rotate-180" : ""
                    }`}
              ...
              <div className="pt-6">
                ...
                <ul className="columns-1 sm:columns-2 md:columns-3 lg:columns-4">
                  <li className="py-2">
                    <CheckboxCustom label="Field Day" />
                  </li>
                  <li className="py-2">
                    <CheckboxCustom label="Glastonbury" />
                  </li>
                  <li className="py-2">
                    <CheckboxCustom label="Green Man" />
                  </li>
                  <li className="py-2">
                    <CheckboxCustom label="Lattitude" />
                  </li>
                  <li className="py-2">
                    <CheckboxCustom label="Boomtown" />
                  </li>
                  <li className="py-2">
                    <CheckboxCustom label="Wilderness" />
                  </li>
                  <li className="py-2">
                    <CheckboxCustom label="Exit Festival" />
                  </li>
                  <li className="py-2">
                    <CheckboxCustom label="Primavera Sound" />
                  </li>
                </ul>
              </div>
              <div className="pt-6">
                ...
                <ul className="columns-1 sm:columns-2 md:columns-3 lg:columns-4">
                  <li className="py-2">
                    <CheckboxCustom label="Camping" />
                  </li>
                  <li className="py-2">
                    <CheckboxCustom label="Trekking" />
                  </li>
                  <li className="py-2">
                    <CheckboxCustom label="Off Road" />
                  </li>
                  <li className="py-2">
                    <CheckboxCustom label="Camp Fire" />
                  </li>
                  <li className="py-2">
                    <CheckboxCustom label="Exploring" />
                  </li>
                </ul>
              </div>
            </Accordion>
        ...
        <div className="col-span-12 lg:col-span-6">
          <div className="rounded-2xl bg-white border p-4 md:p-6 lg:p-8">
            <Accordion
              buttonContent={(open) => (
                <div className="rounded-2xl flex items-center justify-between">
                  <h3 className="h3">Event Pictures and Videos </h3>
                  <ChevronDownIcon
                    className={`w-5 h-5 sm:w-6 sm:h-6 duration-300 ${
                      open ? "rotate-180" : ""
                    }`}
