...
const Page = () => {
  return (
    <div className="bg-[var(--bg-2)]">
      <div className="flex items-center justify-between flex-wrap px-3 py-5 md:p-[30px] gap-5 lg:p-[60px] bg-[var(--dark)]">
        <h2 className="h2 text-white">Currencies</h2>
        <Link href="/flight/add-new-flight" className="btn-primary">
          <PlusCircleIcon className="w-5 h-5" /> Add New Currency
        </Link>
      </div>
              ...
              <table className="w-full whitespace-nowrap">
                <thead>
                  <tr className="text-left bg-[var(--bg-1)] border-b border-dashed">
                    ...
                    <th className="py-3 font-medium lg:py-4 px-2">Symbol</th>
                    <th className="py-3 font-medium lg:py-4 px-2">Country</th>
                    <th className="py-3 font-medium lg:py-4 px-2">Value</th>
                    <th className="py-3 font-medium lg:py-4 px-2">Checkout</th>
                    <th className="py-3 font-medium lg:py-4 px-2">Action</th>
                  </tr>
                </thead>
                <tbody>
                  {currencies.map(({ id, country, name, value, symbol }) => (
                    <tr
                      key={id}
 ...
 lg:px-4">
                      ...
                      <td className="py-3 lg:py-4 px-2">{symbol}</td>
                      <td className="py-3 lg:py-4 px-2">{country}</td>
                      <td className="py-3 lg:py-4 px-2">{value}</td>
                      <td className={`py-3 lg:py-4 px-2`}>
                        <div className="inline-flex gap-1 pr-3 items-center rounded-xl text-primary bg-[#EBEBFD]">
                          <select className="bg-transparent focus:outline-none p-3">
                            <option value="1">Set Default</option>
                            <option value="2">Set Standard</option>
                          </select>
                        </div>
                      </td>
