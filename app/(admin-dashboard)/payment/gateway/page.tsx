...
import HeadlessListPayment from "@/components/ListBoxPayment";
...
const Page = () => {
 ...
 lg:px-4">
                        ...
                        <td className={`py-3 lg:py-4 px-2`}>
                          <div className={`w-40`}>
                            <HeadlessListPayment initialValue={checkout} />
                          </div>
                        </td>
                        <td className={`py-3 lg:py-4 px-2`}>
                          <div className={`w-40`}>
                            <HeadlessListPayment initialValue={deposit} />
                          </div>
                        </td>
                        <td className={`py-3 lg:py-4 px-2`}>
                          <div className={`w-40`}>
                            <HeadlessListPayment initialValue={subscription} />
                          </div>
                        </td>
