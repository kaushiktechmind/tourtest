  ...
  return (
    <div className="bg-[var(--bg-2)]">
      <div className="flex items-center justify-between flex-wrap px-3 py-5 md:p-[30px] gap-5 lg:p-[60px] bg-[var(--dark)]">
        <h2 className="h2 text-white">Seat Type</h2>
      ...
      <section className="grid z-[1] grid-cols-12 gap-4 mb-6 lg:gap-6 px-3 md:px-6 bg-[var(--bg-2)] relative after:absolute after:bg-[var(--dark)] after:w-full after:h-[60px] after:top-0 after:left-0 after:z-[-1] pb-10 xxl:pb-0">
        <div className="col-span-12 lg:col-span-6">
          <div className=" p-4 md:p-6 lg:p-10 rounded-2xl bg-white">
            <h3 className="border-b h3 pb-6">Add Seat Type</h3>
            <form>
              <label
                htmlFor="name"
              ...
              <input
                ...
                className="w-full border py-3 px-3 mb-5 lg:px-6 rounded-md focus:outline-none focus:border focus:border-primary outline-1"
              />
            ...
            <table className="w-full whitespace-nowrap">
              ...
              <tbody>
                <tr className="border-b border-dashed hover:bg-[var(--bg-1)] duration-300">
                  <td className="w-1/2 py-3 lg:py-4 px-2">Firt Class</td>
                  <td className="py-3 lg:py-4 px-2">25/05/2023/</td>
                ...
                <tr className="border-b border-dashed hover:bg-[var(--bg-1)] duration-300">
                  <td className="w-1/2 py-3 lg:py-4 px-2">Business</td>
                  <td className="py-3 lg:py-4 px-2">19/05/2023/</td>
                  <td className="py-3 lg:py-4 px-2 flex gap-2 items-center">
                    <button className="text-primary">
                      <PencilSquareIcon className="w-5 h-5" />
                    </button>
                ...
                <tr className="border-b border-dashed hover:bg-[var(--bg-1)] duration-300">
                  <td className="w-1/2 py-3 lg:py-4 px-2">Premium</td>
                  <td className="py-3 lg:py-4 px-2">25/05/2023/</td>
                  <td className="py-3 lg:py-4 px-2 flex gap-2 items-center">
                    <button className="text-primary">
                      <PencilSquareIcon className="w-5 h-5" />
                ...
                <tr className="border-b border-dashed hover:bg-[var(--bg-1)] duration-300">
                  <td className="w-1/2 py-3 lg:py-4 px-2">Economy</td>
                  <td className="py-3 lg:py-4 px-2">25/05/2023/</td>
                  <td className="py-3 lg:py-4 px-2 flex gap-2 items-center">
                    <button className="text-primary">
                      <PencilSquareIcon className="w-5 h-5" />
                ...
                <tr className="border-b border-dashed hover:bg-[var(--bg-1)] duration-300">
                  <td className="w-1/2 py-3 lg:py-4 px-2">VIP</td>
                  <td className="py-3 lg:py-4 px-2">25/05/2023/</td>
                  <td className="py-3 lg:py-4 px-2 flex gap-2 items-center">
                    <button className="text-primary">
                      <PencilSquareIcon className="w-5 h-5" />
