            ...
            <div className="px-4 md:px-6 lg:px-8 pb-4 md:pb-6 lg:pb-8 bg-white rounded-b-2xl">
              ...
              <p className="mt-6 mb-4 text-xl font-medium">Hotel ID</p>
                <input
                  ...
                  placeholder="7567DF8"
                />
                 <p className="mt-6 mb-4 text-xl font-medium">Room Name</p>
                <input
                  type="text"
                  className="w-full border p-2 focus:outline-none rounded-md text-base"
                ...
                <input
                  ...
                  placeholder="Name of Room"
                />
                <p className="mt-6 mb-4 text-xl font-medium">Extra Bed</p>
                <input
                  type="number"
                  className="w-full border p-2 focus:outline-none rounded-md text-base"
                  placeholder="Name of Room"
                />
                 <p className="mt-6 mb-4 text-xl font-medium">Price for Child</p>
                <input
                  type="number"
                  className="w-full border p-2 focus:outline-none rounded-md text-base"
                  placeholder="1999"
  ...
  <div className="w-full flex flex-col">
    ...
    />
                ...
                <textarea
                  ...
                  defaultValue="Burj Al Arab is a luxury hotel located in Dubai, United Arab Emirates. It is known for its distinctive sail-shaped structure, which has become a symbol of modern Dubai.
                  The hotel is situated on an artificial island and is connected to the mainland by a private bridge. It is considered one of the most luxurious hotels in the world, with amenities such as personal butlers, private beach access, and helipad."></textarea>
              </div>
            </div>
          </Accordion>
          <Accordion
            ...
            initialOpen={true}>
            <div className="px-4 md:px-6 lg:px-8 pb-4 md:pb-6 lg:pb-8 bg-white rounded-b-2xl">
              <p className="mb-4 text-xl font-medium"> Available Rooms : </p>
              <SelectUI
                options={[{ name: "1" }, { name: "2" }, { name: "3" },  { name: "4" },  { name: "5" }]}
              />
              <p className="mt-6 mb-4 text-xl font-medium">Room Available :</p>
              <SelectUI
                options={[{ name: "1" }, { name: "2" }, { name: "3" }]}
              />
              <p className="mt-6 mb-4 text-xl font-medium">Number of Extra Beds :</p>
              <SelectUI
                options={[
                  { name: "1" },
                  { name: "2" },
            ...
            <Accordion
              buttonContent={(open) => (
                <div className="rounded-2xl flex items-center justify-between">
                  <h3 className="h3">Featured Image </h3>
                  <ChevronDownIcon
                    className={`w-5 h-5 sm:w-6 sm:h-6 duration-300 ${
                      open ? "rotate-180" : ""
                    }`}
              ...
              <div className="pt-6">
                ...
                <input
                  ...
                  defaultValue="https://www.youtube.com/watch?v=ffffafgsfg   "
                />
                <div className="mt-6">
                ...
                <input
                  ...
                  defaultValue="Ridgeway, Ibstone Road, Stokenchurch, HP14 3XR"
                />
              </div>
            </Accordion>
          </div>
            ...
            <Accordion
              ...
              <div className="pt-6">
                ...
                <input
                  ...
                  defaultValue="curtis.weaver@example.com"
                />
                ...
                <input
                  ...
                  defaultValue="https://news.google.com"
                />
                <Link
                  href="#"
