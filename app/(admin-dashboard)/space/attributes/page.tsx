            ...
            <table className="w-full whitespace-nowrap">
              <thead>
                <tr className="text-left bg-[var(--bg-1)] border-b border-dashed">
                  <th className="py-3 lg:py-4 font-medium px-2">Name</th>
                  <th className="py-3 lg:py-4 font-medium px-2">
                    Position Order
                  </th>
                  <th className="py-3 lg:py-4 font-medium px-2">Date</th>
                  <th className="py-3 lg:py-4 font-medium px-2">Action</th>
                </tr>
              </thead>
              <tbody>
