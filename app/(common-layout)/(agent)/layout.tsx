              ...
              <ul className="flex flex-col gap-4 mb-10 max-text-30 mx-auto">
                <li>
                  <div className="flex items-center gap-2">
                    <i className="las text-xl sm:text-2xl la-phone-volume text-primary"></i>
                    <p className="mb-0"> (505) 555-0125, (270) 555-0117 </p>
                  </div>
                </li>
                <li>
                  <div className="flex items-center gap-2">
                    <i className="las text-xl sm:text-2xl la-envelope-open text-[#22804A]"></i>
                    <p className="mb-0"> willie.jennings@example.com </p>
                  </div>
                </li>
                <li>
                  <div className="flex items-center gap-2">
                    <i className="las text-xl sm:text-2xl la-map-marker-alt text-[#9C742B]"></i>
                    <p className="mb-0"> 3605 Parker Rd.</p>
                  </div>
                </li>
              </ul>
