    ...
    <ul className="flex flex-col gap-6">
      <li>
        <div className="p-3 sm:p-4 lg:p-6 xl:p-10 rounded-2xl bg-white shadow-3">
          ...
          <div className="bg-[#EBEBFD] rounded-2xl h-2 my-5 flex">
            <div className="bg-[#363AED] h-2 rounded-s-2xl w-[25%]"></div>
            <div className="bg-[#8A8DF5] h-2 w-[15%]"></div>
          </div>
          <ul className="flex items-center gap-3 flex-wrap">
            ...
            <li>
              <div className="flex items-center gap-2">
                <span className="grid w-2 h-2 rounded-full bg-[#8A8DF5] shrink-0"></span>
                <span className="inline-block text-sm">Shared space</span>
              </div>
            </li>
            <li>
              <div className="flex items-center gap-2">
                <span className="grid w-2 h-2 rounded-full bg-[#EBEBFD] shrink-0"></span>
