...
export default function Page({
  ...
  const handleSelectFerry = (shipClassId: string) => {
    ...
    if (selectedFerry) {
      ...
      router.push(storedFrom2 ? `/ferry-list2/${storedTripType}` : "/ferry");
    } else {
  ...
  const handleSearch = () => {
    ...
    updateLocalStorage();
    window.location.href = `/ferry-list/${tripType}`;
                  ...
                  <div key={schedule.id || index} className="col-span-1">
                    <div className="md:flex bg-white border rounded-2xl mx-3 xl:mx-0">
                      ...
                      <div className="p-3 lg:p-6 xl:pt-10 xxl:pt-14 bg-[var(--bg-2)] text-center md:text-start rounded-e-2xl">
                        ...
                        <Link
                          href={localStorage.getItem('access_token') ? (storedFrom2 ? `/ferry-list2/${storedTripType}` : "/ferry") : "/sign-in"}
                          onClick={(e) => {
                            if (!localStorage.getItem('access_token')) {
                  ...
                  <div key={schedule.id || index} className="col-span-1">
                    <div className="md:flex bg-white border rounded-2xl mx-3 xl:mx-0">
                      ...
                      <div className="p-3 lg:p-6 xl:pt-10 xxl:pt-14 bg-[var(--bg-2)] text-center md:text-start rounded-e-2xl">
                        ...
                        <Link
                          href={storedFrom2 ? `/ferry-list2/${storedTripType}` : "/ferry"}
