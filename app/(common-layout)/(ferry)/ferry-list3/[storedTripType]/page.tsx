...
export default function Page({
  ...
  params: { storedTripType?: string };
}) {
  const { storedTripType } = params;
  ...
  const toId = locationIds[to3] || null;
  ...
  const fetchScheduleData = async () => {
    ...
    const requestPayload = {
      data: {
        ...
        to_location: toId,
        travel_date: travelData?.travel_date3,
        return_travel_date: travelData?.travel_date3,
            ...
            <div className="py-6 px-8 bg-white rounded-2xl shadow-lg">
              ...
              <div className="flex items-center justify-between rounded-full border bg-[var(--bg-2)] px-5 py-3">
                <input
                  ...
                  placeholder="Search by ferry name"
                />
                <button
                  type="button"
                ...
                <div key={schedule.id || index} className="col-span-1">
                  <div className="md:flex bg-white border rounded-2xl mx-3 xl:mx-0">
                    ...
                    <div className="p-3 lg:p-6 xl:pt-10 xxl:pt-14 bg-[var(--bg-2)] text-center md:text-start rounded-e-2xl">
                      ...
                      <Link
                        href={localStorage.getItem('access_token') ? "/ferry" : "/sign-in"}
                        onClick={(e) => {
                          if (!localStorage.getItem('access_token')) {
              ...
              {isDialogOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center transition-opacity">
                  <div className="bg-white p-6 rounded-lg w-1/2">
                    ...
                    <Link href="/ferry" className="mt-4 ml-2 bg-primary text-white p-2 rounded-lg">Proceed</Link>
                  </div>
                </div>
              )}
