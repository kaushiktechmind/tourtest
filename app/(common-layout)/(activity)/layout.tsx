                    ...
                    <ul className="flex justify-between items-center flex-wrap gap-3 ">
                      ...
                      <li className="flex-grow">
                        <ul className="flex flex-wrap justify-end justify-content-lg-start justify-content-xl-center gap-4">
                          <li>
                            <Link
                              href="/activity-listing-grid"
                              className={`link flex items-center gap-2 clr-neutral-500 hover:text-primary ${path === "/activity-listing-grid" && "text-primary"
                                }`}>
                          ...
                          <li>
                            <Link
                              ...
                              className={`link flex items-center gap-2 clr-neutral-500 hover:text-primary ${path === "/activity-listing" && "text-primary"
                                }`}>
