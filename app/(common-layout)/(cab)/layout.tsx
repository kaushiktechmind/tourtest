                    ...
                    <li className="flex-grow">
                      <ul className="flex flex-wrap justify-start gap-4">
                        <li className="flex items-center gap-4">
                          <Link
                            href={`/cabs`}
                            className={`link flex items-center gap-2 clr-neutral-500 hover:text-primary ${path === "/cabs" && "text-primary"
                              }`}
                          >
                          ...
                          <Link
                            href={`/cablist`}
                            className={`link flex items-center gap-2 clr-neutral-500 hover:text-primary ${path === "/cablist" && "text-primary"
                              }`}
                          >
