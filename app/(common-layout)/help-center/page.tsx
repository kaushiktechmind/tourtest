      ...
      <header className="text-white px-3 text-center py-[60px] lg:py-[120px] bg-[var(--dark)]">
        ...
        <div className="max-w-[680px] mx-auto text-center justify-center gap-3 flex flex-wrap">
          <Link href="#" className="flex gap-1 items-center">
            How Can We Help? <XMarkIcon className="w-5 h-5" />
          </Link>
          <Link href="#" className="flex gap-1 items-center">
            How to upload data to the system? <XMarkIcon className="w-5 h-5" />
          </Link>
          <Link href="#" className="flex gap-1 items-center">
            Installation Guide? <XMarkIcon className="w-5 h-5" />
          </Link>
          <Link href="#" className="flex gap-1 items-center">
            How to view expired tickets? <XMarkIcon className="w-5 h-5" />
          </Link>
          <Link href="#" className="flex gap-1 items-center">
            View All Question
