                ...
                <ul className="flex flex-col gap-4 mb-8">
                  <li>
                    <div className="border rounded-full px-6 bg-transparent">
                      <select
                        className="w-full bg-transparent py-3 focus:outline-none clr-neutral-300"
                        aria-label="Default select example">
                        <option>Select More Properties</option>
                        <option value="1">RCE Theaters Backford Dr</option>
                        <option value="2">Chick Fill A - Lake</option>
                        <option value="3">Glanword Ave ste</option>
                      </select>
                    </div>
                  </li>
                  <li>
