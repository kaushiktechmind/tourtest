  ...
  return (
    <div>
      ...
      <section className="bg-white px-3 lg:px-6 grid grid-cols-12 gap-4 lg:gap-6 pt-6">
        <div className="col-span-12 lg:col-span-6 px-3 pt-3 sm:px-4 sm:pt-4 md:pt-6 lg:pt-8 md:px-8 lg:px-10 border rounded-2xl">
          <h3 className="h3 mb-4">Booking Stats</h3>
          <Chart options={options} height={250} type="area" series={series} />
        </div>
