...
const FeaturedCardHome2 = ({ item }: any) => {
  ...
  return (
    <div key={id} className="col-span-12 xl:col-span-4 px-3 xl:px-0">
    <div className="bg-white hover:shadow-lg duration-300 grid grid-cols-12 rounded-2xl p-2 h-full">
      {/* Image Section */}
      <div className="rounded-2xl col-span-12 md:col-span-12 relative group h-100">
        {img.length > 1 ? (
          <Swiper
            loop={true}
            pagination={{
      ...
      {/* Content Section */}
      <div className="col-span-12 md:col-span-12 flex flex-col justify-between h-full mt-4">
  <div>
    {/* Address */}
    ...
    <Link
      ...
      className="text-xl font-medium text-neutral-700 pl-4 h-[3rem] leading-snug line-clamp-2 overflow-hidden"
    >
      {title}
    </Link>
