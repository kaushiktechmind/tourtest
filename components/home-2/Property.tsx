    ...
    try {
      ...
      setCategories((prevCategories) => ({
        ...
        [location]: apiData.length > 0
          ? apiData.map((item: { id: any; hotel_name: any; location_name: any; seo_title: any, no_of_bedrooms: any; hotel_or_home_stay: any; no_of_beds: any; no_of_bathrooms: any; room_size: any; starting_price: any; highest_price: any; banner_images: any; }) => ({
              id: item.id,
