    ...
    <section className="py-[60px] lg:py-[120px] bg-[#04052F] relative">
      ...
      <div className="container">
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-3 text-white text-center">
            <div className="text-4xl rounded-full mb-4 bg-[#22804A] w-20 h-20 flex items-center justify-center mx-auto">
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-3 text-white text-center">
            <div className="text-4xl rounded-full mb-4 bg-[#9C742B] w-20 h-20 flex items-center justify-center mx-auto">
