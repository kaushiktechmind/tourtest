...
export default function LangDropdown() {
  return (
    <div className="w-[115px] text-left z-10">
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    <span className="text-gray-800 text-base">English</span>
                    <span className="text-gray-500 text-xs">United States</span>
                  </button>
                )}
              </Menu.Item>
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    <span className="text-gray-800 text-base">Spanish</span>
                    <span className="text-gray-500 text-xs">Spanish</span>
                  </button>
                )}
              </Menu.Item>
            </div>
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    <span className="text-gray-800 text-base">Bangla</span>
                    <span className="text-gray-500 text-xs">Bangladesh</span>
                  </button>
                )}
              </Menu.Item>
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    <span className="text-gray-800 text-base">Hindi</span>
