...
const RazorpayCabBtn: React.FC<RazorpayCabBtnProps> = ({ grandTotal, pickupPoint, dropPoint, discountAmount, discountedPrice, inclusions, exclusions, formattedDate, todayDate, name, email, mobile_number, passport, country, bookingID, currency, cabId, address }) => {
    ...
    const totalPrice = storedCabDetails.totalPrice || "";
            ...
            <div class="main-header">
               ...
               <table>
                  ...
                  <tr>
                     ...
                     <td>
                        <strong>
                        ₹${Number(discountedPrice) > 0 ? discountedPrice : totalPrice}/-
                        </strong>
                     </td>
                  </tr>
               </table>
              ...
              `;
                    ...
                    const pdf = html2pdf()
                        ...
                        .then(async (pdf: { output: (arg0: string) => any; }) => {
                            ...
                            formData.append('arrival_place', pickupPoint);
                            formData.append('drop_point', dropPoint);
