         ...
         <div style="border-left: 1px solid #b6b6b6; height: 200px;"></div>
            ...
            <p>Cab: ${cabName}</p>
              ...
              <p>Booking Date: ${todayDate}</p>
                    ...
                    <p>Arrival Place: ${arrival_place}</p>
                </div>
            </div>
            <br>
        <hr>
              ...
              `;
                    ...
                    const pdf = html2pdf()
                        ...
                        .then(async (pdf: { output: (arg0: string) => any; }) => {
                            ...
                            formData.append('cab_name', cabName || '');
                            formData.append('address', address || '');
                            formData.append('passport_no', passport || '');
                            formData.append('country', country || '');
                            formData.append('starting_date', formattedDate); // Replace with correct value
                            formData.append('service_type', "Cab"); // Adjust if needed
                            formData.append('booking_id', bookingID);
                            formData.append('arrival_place', arrival_place);
                            formData.append('min_pax', selectedPax);
