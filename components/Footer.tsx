        ...
        <div className="container">
          ...
          <div className="px-3">
            ...
            <p className="clr-neutral-30 mb-6 mt-6 text-white text-justify leading-relaxed border-b border-dashed border-white pb-4">
              ...
              We offer a wide range of accommodations for your perfect getaway. explore the <a href="/hotels" className="text-blue-500"> best hotels in andaman</a>, including <a href="/hotels" className="text-blue-500">hotels in port blair</a> and  <a href="/hotels" className="text-blue-500">hotels in havelock island</a> like the <a href="/hotels" className="text-blue-500">resort in havelock</a> and <a href="/hotels" className="text-blue-500">resort in neil island</a>. whether you are looking for <a href="/hotels" className="text-blue-500">luxury resorts in andaman</a>, <a href="/hotels" className="text-blue-500">havelock beach resort</a>, or <a href="/hotels" className="text-blue-500">neil island resorts</a>, we provide excellent options.
