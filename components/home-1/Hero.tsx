...
const Hero = () => {
  return (
    <section className="relative bg-[var(--bg-1)] border-t lg:border-t-0">
      ...
      <Image
        priority
        className="absolute hidden lg:block w-[25%] left-0 bottom-0 z-[2]"
      ...
      <Image
        priority
        className="absolute top-24 scale-50 sm:scale-75 lg:scale-100 lg:top-20 left-2 lg:left-[16%] z-[3]"
