      ...
      <div className="container">
        <div className="flex justify-between gap-4 mb-8 flex-wrap">
          ...
          <div className="flex gap-4">
            <div className="prev-btn rounded-full border flex items-center justify-center hover:bg-primary cursor-pointer text-primary duration-300 hover:text-white border-[var(--primary)] w-12 h-12 self-center">
              <i className="las la-angle-left text-2xl"></i>
            </div>
            <div className="next-btn rounded-full border flex items-center justify-center hover:bg-primary cursor-pointer text-primary duration-300 hover:text-white border-[var(--primary)] w-12 h-12 self-center">
