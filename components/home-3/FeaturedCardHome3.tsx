...
const FeaturedCardHome3 = ({ item }: any) => {
  ...
  return (
    <div
      key={id}
      className="col-span-12 md:col-span-6 xl:col-span-4 px-3 xl:px-0 group">
      <div className="bg-white hover:shadow-lg duration-300 rounded-2xl p-2">
...
export default FeaturedCardHome3;
