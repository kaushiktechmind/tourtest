...
const RazorpayPkgBtn: React.FC<RazorpayPkgBtnProps> = ({ grandTotal, todayDate, itinerary, inclusions, exclusions, name, email, mobile_number, passport, country, bookingID, currency, packageId, address }) => {
