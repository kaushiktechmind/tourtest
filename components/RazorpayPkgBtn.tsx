...
const RazorpayPkgBtn: React.FC<RazorpayPkgBtnProps> = ({ grandTotal, discountedPrice, discountAmount, todayDate, itinerary, inclusions, exclusions, name, email, mobile_number, passport, country, bookingID, currency, packageId, address }) => {
  const router = useRouter();


  const day1 = `Day ${itinerary?.[0]?.day || ''}`;

  const title1 = itinerary?.[0]?.title || '';
  const desc1 = itinerary?.[0]?.description || '';

  const day2 = `Day ${itinerary?.[1]?.day || ''}`;
  const title2 = itinerary?.[1]?.title || '';
  const desc2 = itinerary?.[1]?.description || '';

  const day3 = `Day ${itinerary?.[2]?.day || ''}`;
  const title3 = itinerary?.[2]?.title || '';
  const desc3 = itinerary?.[2]?.description || '';

  const day4 = `Day ${itinerary?.[3]?.day || ''}`;

  const title4 = itinerary?.[3]?.title || '';
  const desc4 = itinerary?.[3]?.description || '';

  const day5 = `Day ${itinerary?.[4]?.day || ''}`;
  const title5 = itinerary?.[4]?.title || '';
  const desc5 = itinerary?.[4]?.description || '';
  ...
  console.log("ssssssssssssssssssssssss", grandTotal)
  ...
  const {
    ...
    infant1, infant2, infantPrice1, infantPrice2, date, adultAge, childAge1, childAge2, childAge3, infantAge1, infantAge2
  } = storedPackageData[0];

  const formattedDate = new Date(date).toLocaleDateString("en-GB").replace(/\//g, '-');

  const flagDate = new Date(formattedDate.split('-').reverse().join('-'));


  const date1 = new Date(flagDate.setDate(flagDate.getDate())).toLocaleDateString('en-GB');
  const date2 = new Date(flagDate.setDate(flagDate.getDate() + 1)).toLocaleDateString('en-GB');
  const date3 = new Date(flagDate.setDate(flagDate.getDate() + 1)).toLocaleDateString('en-GB');
  const date4 = new Date(flagDate.setDate(flagDate.getDate() + 1)).toLocaleDateString('en-GB');
...
<body>
    ...
    <br>
        ...
        ${adultAge && Number(adult) ? (`
          <tr>
             <td>Adult ${adultAge}</td>
             <td>${adult}</td>
             <td>₹${adultPrice}</td>
          ...
          ${childAge1 && Number(child1) ? (`
          <tr>
             <td>Child ${childAge1}</td>
             <td>${child1}</td>
             <td>₹${childPrice1}</td>
          ...
          ${childAge2 && Number(child2) ? (`
          <tr>
             <td>Child ${childAge2}</td>
             <td>${child2}</td>
             <td>₹${childPrice2}</td>
          ...
          ${childAge3 && Number(child3) ? (`
          <tr>
             <td>Child ${childAge3}</td>
             <td>${child3}</td>
             <td>₹${childPrice3}</td>
          ...
          ${infantAge1 && Number(infant1) ? (`
          <tr>
             <td>Infant ${infantAge1}</td>
             <td>${infant1}</td>
             <td>₹${infantPrice1}</td>
          ...
          ${infantAge2 && Number(infant2) ? (`
          <tr>
             <td>Infant ${infantAge2}</td>
             <td>${infant2}</td>
             <td>₹${infantPrice2}</td>
         ...
         <tr>
                   ...
                   <tr>
                     ...
                     <td><strong>₹${Math.round(discountAmount)}</strong></td>
                  </tr>
                  ...
                  <tr>
                     ...
                     <td>
                        <strong>
                        ₹${Number(Math.round(discountedPrice) > 0 ? discountedPrice : grandTotal / 100)}/-
                        </strong>
                     </td>
			</table>
		</div>
...
<div class="itinerary" style="width: 100%;">
  <h1 class="main-header" style="font-size: 20px">Itinerary</h1>

  <!-- Day 1 -->
  ${title1 ? `
  <div style="display: flex; align-items: center; gap: 20px; padding: 10px 0;">
    <div style="width: 10%; font-weight: bold;">${day1}</div>
  ...
  ${title2 ? `
  <div style="display: flex; align-items: center; gap: 20px; padding: 10px 0;">
    <div style="width: 10%; font-weight: bold;">${day2}</div>
      <div style="width: 20%;">
					<p>${date2}</p>
				</div>
    <div style="width: 70%;">
  ...
  ${title3 ? `
  <div style="display: flex; align-items: center; gap: 20px; padding: 10px 0;">
    <div style="width: 10%; font-weight: bold;">${day3}</div>
      <div style="width: 20%;">
					<p>${date3}</p>
				</div>
    <div style="width: 70%;">
  ...
  ${title4 ? `
  <div style="display: flex; align-items: center; gap: 20px; padding: 10px 0;">
    <div style="width: 10%; font-weight: bold;">${day4}</div>
      <div style="width: 20%;">
					<p>${date4}</p>
				</div>
    <div style="width: 70%;">
  ...
  ${title5 ? `
  <div style="display: flex; align-items: center; gap: 20px; padding: 10px 0;">
    <div style="width: 10%; font-weight: bold;">${day5}</div>
      <div style="width: 20%;">
					<p>${date5}</p>
				</div>
    <div style="width: 70%;">
		...
		<div class="invoice-footer" style="text-align: center;">
          ...
          const pdf = html2pdf()
            ...
            .then(async (pdf: { output: (arg0: string) => any; }) => {
              ...
              formData.append('discount_price', discountAmount);
