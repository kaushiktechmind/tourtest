...
const RazorpayActBtn: React.FC<RazorpayActBtnProps> = ({ grandTotal, discountAmount, discountedPrice, todayDate, formattedDate, name, email, mobile_number, passport, country, bookingID, currency, activityId, address }) => {
    ...
    const subTotal = storedActivityData.grandTotal;
