  ...
  return (
    <div className="pb-[60px] lg:pb-[120px] lg:pt-[60px] bg-white">
      <div className="container">
        <div className="grid grid-cols-12 gap-5 md:gap-0 justify-between divide-x divide-dashed">
            ...
            <div className="text-center">
              ...
              <span className="block mt-6 mb-2 text-2xl md:text-[40px] leading-[125%] font-semibold">
                <span className="counter-up" style={{ visibility: "visible" }}>
                  <CounterElement end={10.6} decimals={1} />
                </span>
                k
              </span>
          ...
          <div className="col-span-12 sm:col-span-6 md:col-span-3">
            <div className="text-center">
              ...
              <span className="block mt-6 mb-2 text-2xl md:text-[40px] leading-[125%] font-semibold">
                <span className="counter-up" style={{ visibility: "visible" }}>
                  <CounterElement end={27.5} decimals={1} />
                </span>
                k
              </span>
              <p className="mb-0 text-[var(--neutral-700)]">
          ...
          <div className="col-span-12 sm:col-span-6 md:col-span-3">
            <div className="text-center">
              ...
              <span className="block mt-6 mb-2 text-2xl md:text-[40px] leading-[125%] font-semibold">
                <span className="counter-up" style={{ visibility: "visible" }}>
                  <CounterElement end={2.3} decimals={1} />
                </span>
                k
              </span>
              <p className="mb-0 text-[var(--neutral-700)]">
          ...
          <div className="col-span-12 sm:col-span-6 md:col-span-3">
            <div className="text-center">
              ...
              <span className="block mt-6 mb-2 text-2xl md:text-[40px] leading-[125%] font-semibold">
                <span className="counter-up" style={{ visibility: "visible" }}>
                  <CounterElement end={1.5} decimals={1} />
                </span>
                k
              </span>
