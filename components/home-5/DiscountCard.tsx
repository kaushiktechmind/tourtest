import discountimg1 from "@/public/img/discount-img-3.jpg";
import discountimg2 from "@/public/img/discount-img-4.jpg";
...
const DiscountCard = () => {
  return (
    <div className="relative after:bg-white after:absolute after:bottom-0 after:left-0 after:w-full after:h-[50%] px-3">
            ...
            <Swiper
              ...
              <SwiperSlide>
                <div className="rounded-2xl relative z-[1] min-h-[200px]">
                  ...
                  />
                  <div className="absolute top-0 right-0 p-3 sm:p-6 lg:p-8 xl:p-10 text-right">
